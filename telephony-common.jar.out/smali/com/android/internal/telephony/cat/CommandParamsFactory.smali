...
.method private processEventNotify(Lcom/android/internal/telephony/cat/CommandDetails;Ljava/util/List;)Z
    ...
    .line 705
    const-string/jumbo v8, "process EventNotify"
    ...
    iput-object v8, v6, Lcom/android/internal/telephony/cat/TextMessage;->text:Ljava/lang/String;
    ...
    iput-boolean v8, v6, Lcom/android/internal/telephony/cat/TextMessage;->iconSelfExplanatory:Z

    .line 720
    .end local v2    # "iconId":Lcom/android/internal/telephony/cat/IconId;
    :cond_0
    iput-boolean v10, v6, Lcom/android/internal/telephony/cat/TextMessage;->responseNeeded:Z
    ...
    sget-object v8, Lcom/android/internal/telephony/cat/AppInterface$CommandType;->SEND_SMS:Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    ...
    const-string/jumbo v9, "The smsc address is "
    ...
    :goto_0
    sget-object v8, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->SMS_TPDU:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    const-string/jumbo v9, "The SMS tpdu is "
    ...
    :goto_1
    new-instance v8, Lcom/android/internal/telephony/cat/SendSMSParams;

    invoke-direct {v8, p1, v6, v5, v4}, Lcom/android/internal/telephony/cat/SendSMSParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;Lcom/android/internal/telephony/cat/TextMessage;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 764
    iput-boolean v11, p0, Lcom/android/internal/telephony/cat/CommandParamsFactory;->mloadIcon:Z
    ...
    .local v5, "smscAddress":Ljava/lang/String;
    :cond_1
    const-string/jumbo v8, "The smsc address is null"
    ...
    .end local v5    # "smscAddress":Ljava/lang/String;
    :cond_2
    const-string/jumbo v8, "The SMS tpdu is null"
    ...
    .end local v4    # "pdu":Ljava/lang/String;
    :cond_3
    sget-object v8, Lcom/android/internal/telephony/cat/AppInterface$CommandType;->SEND_USSD:Lcom/android/internal/telephony/cat/AppInterface$CommandType;
    ...
    sget-object v8, Lcom/android/internal/telephony/cat/ComprehensionTlvTag;->USSD_STRING:Lcom/android/internal/telephony/cat/ComprehensionTlvTag;
    ...
    const-string/jumbo v9, "The ussd string is "
    ...
    :goto_3
    new-instance v8, Lcom/android/internal/telephony/cat/SendUSSDParams;

    invoke-direct {v8, p1, v6, v7}, Lcom/android/internal/telephony/cat/SendUSSDParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;Lcom/android/internal/telephony/cat/TextMessage;Ljava/lang/String;)V
    ...
    .local v7, "ussdString":Ljava/lang/String;
    :cond_4
    const-string/jumbo v8, "The ussd string is null"
    ...
    invoke-direct {v8, p1, v6}, Lcom/android/internal/telephony/cat/DisplayTextParams;-><init>(Lcom/android/internal/telephony/cat/CommandDetails;Lcom/android/internal/telephony/cat/TextMessage;)V
