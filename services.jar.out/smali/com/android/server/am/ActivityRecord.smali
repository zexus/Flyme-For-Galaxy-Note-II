...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessRecord;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZZLcom/android/server/am/ActivityStackSupervisor;Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Landroid/os/Bundle;)V
    ...
    iput-object v0, v1, Lcom/android/server/am/ActivityRecord;->mChildContainers:Ljava/util/ArrayList;
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityRecord;->mStartingWindowShown:Z
    ...
    .line 452
    new-instance v18, Lcom/android/server/am/ActivityRecord$Token;
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/am/ActivityRecord$Token;-><init>(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityManagerService;)V
    ...
    iget-object v0, v0, Lcom/android/server/am/ActivityRecord;->pendingOptions:Landroid/app/ActivityOptions;

    move-object/from16 v18, v0

    invoke-virtual/range {v18 .. v18}, Landroid/app/ActivityOptions;->getLaunchTaskBehind()Z
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityRecord;->mLaunchTaskBehind:Z
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/app/ActivityOptions;->getUsageTimeReport()Landroid/app/PendingIntent;

    move-result-object v17

    .line 487
    .local v17, "usageReport":Landroid/app/PendingIntent;
    if-eqz v17, :cond_0

    .line 488
    new-instance v18, Lcom/android/server/am/AppTimeTracker;

    move-object/from16 v0, v18

    move-object/from16 v1, v17

    invoke-direct {v0, v1}, Lcom/android/server/am/AppTimeTracker;-><init>(Landroid/app/PendingIntent;)V
    ...
    .line 495
    .end local v17    # "usageReport":Landroid/app/PendingIntent;
    :cond_0
    const/16 v18, 0x1
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityRecord;->topIntent:Z
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityRecord;->floatingWindow:Z
    ...
    iput-object v0, v1, Lcom/android/server/am/ActivityRecord;->appInfo:Landroid/content/pm/ApplicationInfo;
    ...
    iput v0, v1, Lcom/android/server/am/ActivityRecord;->logo:I
    ...
    .line 532
    invoke-virtual/range {p14 .. p14}, Lcom/android/server/am/ActivityStackSupervisor;->getFocusedStack()Lcom/android/server/am/ActivityStack;
    ...
    iget-object v0, v14, Lcom/android/server/am/ActivityStack;->mTaskHistory:Ljava/util/ArrayList;
    ...
    iput-boolean v0, v1, Lcom/android/server/am/ActivityRecord;->newAppTask:Z
    ...
    iget-boolean v0, v0, Lcom/android/server/am/ActivityRecord;->newAppTask:Z
    ...
    iget-boolean v0, v0, Lcom/android/server/am/ActivityRecord;->topIntent:Z
    ...
    .line 573
    const-string/jumbo v19, "hide_from_recents_list"
    ...
    .line 577
    .local v7, "excludeFromRecentsList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    if-eqz v9, :cond_13
    ...
    .line 464
    .end local v7    # "excludeFromRecentsList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    .local v13, "record":Lcom/android/server/am/ActivityRecord;
    goto/16 :goto_6

    .line 538
    .end local v13    # "record":Lcom/android/server/am/ActivityRecord;
    :cond_f
    const/4 v8, 0x0

    .restart local v8    # "floats":Z
    goto/16 :goto_7
    ...
    iget-object v0, v13, Lcom/android/server/am/ActivityRecord;->packageName:Ljava/lang/String;
    ...
    .local v15, "taskAppAffinity":Z
    goto/16 :goto_8

    .line 540
    .end local v15    # "taskAppAffinity":Z
    :cond_11
    const/16 v18, 0x0
    ...
    .line 584
    .restart local v7    # "excludeFromRecentsList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    ...
    sget-object v21, Lcom/android/internal/R$styleable;->Window:[I
    ...
    .line 609
    invoke-virtual/range {v18 .. v22}, Lcom/android/server/AttributeCache;->get(Ljava/lang/String;I[II)Lcom/android/server/AttributeCache$Entry;
    ...
    iget-object v0, v6, Lcom/android/server/AttributeCache$Entry;->array:Landroid/content/res/TypedArray;
    ...
    iput v0, v1, Lcom/android/server/am/ActivityRecord;->mActivityType:I
    ...
    .local v16, "translucent":Z
    goto/16 :goto_e

    .line 613
    .end local v16    # "translucent":Z
    :cond_1c
    const/16 v16, 0x0

    .restart local v16    # "translucent":Z
    goto/16 :goto_e
    ...
    const-string/jumbo v19, "com.android.systemui.recents"
